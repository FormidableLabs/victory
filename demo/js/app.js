...
import DillonDemo from "./components/dillon-demo";
import DillonPerf from "./components/dillon-perf";
...
const MAP = {
  ...
  "/dillon": { component: DillonDemo, name: "Dillon Dev" },
  "/dillon-perf": { component: DillonPerf, name: "Dillon Perf" }
};
