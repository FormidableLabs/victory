      ...
      <div className="demo">
        <div style={containerStyle}>
          <VictoryChart style={chartStyle}
            domainPadding={{y: 2}}
            containerComponent={
              <VictoryVoronoiZoomContainer dimension="x"
                labels={(d) => `y: ${d.y}`}
          ...
          <VictoryScatter
            ...
            containerComponent={<VictoryVoronoiZoomContainer dimension="x"/>}
          ...
          <VictoryChart style={chartStyle} containerComponent={<VictoryVoronoiZoomContainer/>}>
          ...
          <VictoryStack style={chartStyle} containerComponent={<VictoryVoronoiZoomContainer/>}>
            <VictoryBar
              style={{
                data: {
                  fill: "tomato",
