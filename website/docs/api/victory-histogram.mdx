...
:::info
For examples of `VictoryHistogram` in action, visit the [Histogram Chart](/docs/charts/histogram-charts) examples.
:::
...
`VictoryHistogram` uses the standard `animate` prop. [Read about it here](/docs/api/common-props#animate)
...
`VictoryHistogram` uses the standard `containerComponent` prop. [Read about it here](/docs/api/common-props#containercomponent)
...
`VictoryHistogram` uses the standard `data` prop, except for it only expects each object within the array to have `x` properties. The `x` data accessor prop can be used to define a custom data format. [Read about it here](/docs/api/common-props#data)
...
`VictoryHistogram` uses the standard `dataComponent` prop. [Read about it here](/docs/api/common-props#datacomponent)
...
`VictoryHistogram` uses the standard `domain` prop. [Read about it here](/docs/api/common-props#domain)
...
`VictoryHistogram` uses the standard `domainPadding` prop. [Read about it here](/docs/api/common-props#domainpadding)
...
`VictoryHistogram` uses the standard `eventKey` prop to specify how event targets are addressed. **This prop is not commonly used.** [Read about the `eventKey` prop in more detail here](/docs/api/common-props#eventkey)
...
`VictoryHistogram` uses the standard `events` prop. [Read about it here](/docs/api/common-props#events)
...
`VictoryHistogram` uses the standard `externalEventMutations` prop. [Read about it in detail](/docs/api/common-props#externalEventsMutations)

## groupComponent

`type: element`

`VictoryHistogram` uses the standard `groupComponent` prop. [Read about it here](/docs/api/common-props#groupcomponent)
...
`VictoryHistogram` uses the standard `height` prop. [Read about it here](/docs/api/common-props#height)
...
`VictoryHistogram` uses the standard `labelComponent` prop. [Read about it here](/docs/api/common-props#labelcomponent)
...
`VictoryHistogram` uses the standard `labels` prop. [Read about it here](/docs/api/common-props#labels)
...
`VictoryHistogram` uses the standard `maxDomain` prop. [Read about it in detail](/docs/api/common-props#maxDomain)
...
`VictoryHistogram` uses the standard `minDomain` prop. [Read about it in detail](/docs/api/common-props#minDomain)
...
`VictoryHistogram` uses the standard `padding` prop. [Read about it here](/docs/api/common-props#padding)
...
`VictoryHistogram` uses the standard `scale` prop. [Read about it here](/docs/api/common-props#scale)
...
`VictoryHistogram` uses the standard `singleQuadrantDomainPadding` prop. [Read about it here](/docs/api/common-props#singlequadrantdomainpadding)

## sortKey

`type: string || integer || array[string] || function`

`VictoryHistogram` uses the standard `sortKey` prop. [Read about it here](/docs/api/common-props#sortkey)
...
`VictoryHistogram` uses the standard `standalone` prop. [Read about it here](/docs/api/common-props#standalone)
...
<svg width={300} height={300}>
  <circle cx={150} cy={150} r={150} fill="lightblue"/>
  <VictoryHistogram
    standalone={false}
...
`VictoryHistogram` uses the standard `style` prop. [Read about it here](/docs/api/common-props#style)
...
```jsx live
  <VictoryHistogram
    style={{
      data: {
        fill: ({ datum }) => datum.y === 3 ? "#000000" : "lightblue",
...
`VictoryHistogram` uses the standard `theme` prop. [Read about it here](/docs/api/common-props#theme)
...
`VictoryHistogram` uses the standard `width` prop. [Read about it here](/docs/api/common-props#width)
...
`VictoryHistogram` uses the standard `x` data accessor prop. [Read about it here](/docs/api/common-props#x)
