...
:::info
For examples of `VictoryAxis` in action, visit the [Chart Axis](/docs/charts/chart-axis) guide.
:::
...
`VictoryAxis` uses the standard `animate` prop. [Read about it here](/docs/api/common-props#animate)
...
`VictoryAxis` uses the standard `containerComponent` prop. [Read about it here](/docs/api/common-props#containercomponent)
...
`VictoryAxis` uses the standard `domain` prop. [Read about it here](/docs/api/common-props#domain)
...
`VictoryAxis` uses the standard `domainPadding` prop. [Read about it here](/docs/api/common-props#domainpadding)
...
`VictoryAxis` uses the standard `events` prop. [Read about it here](/docs/api/common-props#events)
...
`VictoryAxis` uses the standard `externalEventMutations` prop. [Read about it in detail](/docs/api/common-props#externalEventsMutations)
...
`VictoryAxis` uses the standard `groupComponent` prop. [Read about it here](/docs/api/common-props#groupcomponent)
...
`VictoryAxis` uses the standard `height` prop. [Read about it here](/docs/api/common-props#height)
...
`VictoryAxis` uses the standard `maxDomain` prop. [Read about it in detail](/docs/api/common-props#maxDomain). This prop will be ignored when `domain` is set on this component or by a `VictoryChart` parent.
...
`VictoryAxis` uses the standard `minDomain` prop. [Read about it in detail](/docs/api/common-props#minDomain).  This prop will be ignored when `domain` is set on this component or by a `VictoryChart` parent.
...
`VictoryAxis` uses the standard `name` prop. [Read about it here](/docs/api/common-props#name)
...
`VictoryAxis` uses the standard `padding` prop. [Read about it here](/docs/api/common-props#padding)
...
`VictoryAxis` uses the standard `scale` prop. [Read about it here](/docs/api/common-props#scale)
...
`VictoryAxis` uses the standard `singleQuadrantDomainPadding` prop. [Read about it here](/docs/api/common-props#singlequadrantdomainpadding)

## standalone

`type: boolean`

`VictoryAxis` uses the standard `standalone` prop. [Read about it here](/docs/api/common-props#standalone)
...
`VictoryAxis` uses the standard `theme` prop. [Read about it here](/docs/api/common-props#theme)
...
`VictoryAxis` uses the standard `width` prop. [Read about it here](/docs/api/common-props#width)
