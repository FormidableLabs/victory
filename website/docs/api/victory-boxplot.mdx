...
:::info
For examples of `VictoryBoxPlot` in action, visit the [Box Plot](/docs/charts/box-plot-charts) examples.
:::
...
`VictoryBoxPlot` uses the standard `animate` prop. [Read about it here](/docs/api/common-props#animate)
...
`VictoryBoxPlot` uses the standard `categories` prop. [Read about it here](/docs/api/common-props#categories)
...
`VictoryBoxPlot` uses the standard `containerComponent` prop. [Read about it here](/docs/api/common-props#containercomponent)
...
`VictoryBoxPlot` uses the standard `domain` prop. [Read about it here](/docs/api/common-props#domain)
...
`VictoryBoxPlot` uses the standard `domainPadding` prop. [Read about it here](/docs/api/common-props#domainpadding)
...
`VictoryBoxPlot` uses the standard `eventKey` prop to specify how event targets are addressed. **This prop is not commonly used.** [Read about the `eventKey` prop in more detail here](/docs/api/common-props#eventkey)
...
`VictoryBoxPlot` uses the standard `events` prop. [Read about it here](/docs/api/common-props#events)
...
`VictoryBoxPlot` uses the standard `externalEventMutations` prop. [Read about it in detail](/docs/api/common-props#externalEventsMutations)

## groupComponent

`type: element`

`VictoryBoxPlot` uses the standard `groupComponent` prop. [Read about it here](/docs/api/common-props#groupcomponent)
...
`VictoryBoxPlot` uses the standard `height` prop. [Read about it here](/docs/api/common-props#height)
...
`VictoryBoxPlot` uses the standard `maxDomain` prop. [Read about it in detail](/docs/api/common-props#maxDomain)
...
`VictoryBoxPlot` uses the standard `minDomain` prop. [Read about it in detail](/docs/api/common-props#minDomain)
...
`VictoryBoxPlot` uses the standard `padding` prop. [Read about it here](/docs/api/common-props#padding)
...
`VictoryBoxPlot` uses the standard `polar` prop. [Read about it here](/docs/api/common-props#polar)
...
`VictoryBoxPlot` uses the standard `samples` prop. [Read about it here](/docs/api/common-props#samples)
...
`VictoryBoxPlot` uses the standard `scale` prop. [Read about it here](/docs/api/common-props#scale)
...
`VictoryBoxPlot` uses the standard `singleQuadrantDomainPadding` prop. [Read about it here](/docs/api/common-props#singlequadrantdomainpadding)

## sortKey

`type: string || integer || array[string] || function`

`VictoryBoxPlot` uses the standard `sortKey` prop. [Read about it here](/docs/api/common-props#sortkey)
...
`VictoryBoxPlot` uses the standard `standalone` prop. [Read about it here](/docs/api/common-props#standalone)
...
`VictoryBoxPlot` uses the standard `theme` prop. [Read about it here](/docs/api/common-props#theme)
...
`VictoryBoxPlot` uses the standard `width` prop. [Read about it here](/docs/api/common-props#width)
...
`VictoryBoxPlot` uses the standard `x` data accessor prop. [Read about it here](/docs/api/common-props#x)
...
`VictoryBoxPlot` uses the standard `y` data accessor prop. [Read about it here](/docs/api/common-props#y)
