...
:::info
For examples of `VictoryPie` in action, visit the [Pie Chart](/docs/charts/pie-charts) examples.
:::
...
`VictoryPie` uses the standard `animate` prop. [Read about it here](/docs/api/common-props#animate)
...
`VictoryPie` uses the standard `categories` prop. [Read about it here](/docs/api/common-props#categories)
...
`VictoryPie` uses the standard `containerComponent` prop. [Read about it here](/docs/api/common-props#containercomponent)
...
`VictoryPie` uses the standard `data` prop. [Read about it here](/docs/api/common-props#data)
...
`VictoryPie` uses the standard `dataComponent` prop. [Read about it here](/docs/api/common-props#datacomponent)
...
`VictoryPie` uses the standard `eventKey` prop to specify how event targets are addressed. **This prop is not commonly used.** [Read about the `eventKey` prop in more detail here](/docs/api/common-props#eventkey)
...
`VictoryPie` uses the standard `events` prop. [Read about it here](/docs/api/common-props#events)
...
`VictoryPie` uses the standard `externalEventMutations` prop. [Read about it in detail](/docs/api/common-props#externalEventsMutations)

## groupComponent

`type: element`

`VictoryPie` uses the standard `groupComponent` prop. [Read about it here](/docs/api/common-props#groupcomponent)
...
`VictoryPie` uses the standard `height` prop. [Read about it here](/docs/api/common-props#height)
...
`VictoryPie` uses the standard `labelComponent` prop. [Read about it here](/docs/api/common-props#labelcomponent)
...
```jsx live
<VictoryGroup theme={VictoryTheme.clean}>
    <VictoryPie
      data={sampleData}
      labelIndicator 
    />
...
`VictoryPie` uses the standard `labels` prop. [Read about it here](/docs/api/common-props#labels)
...
`VictoryPie` uses the standard `padding` prop. [Read about it here](/docs/api/common-props#padding)
...
`VictoryPie` uses the standard `sortKey` prop. [Read about it here](/docs/api/common-props#sortkey)
...
`VictoryPie` uses the standard `standalone` prop. [Read about it here](/docs/api/common-props#standalone)
...
`VictoryPie` uses the standard `style` prop. [Read about it here](/docs/api/common-props#style)
...
`VictoryPie` uses the standard `theme` prop. [Read about it here](/docs/api/common-props#theme)
...
`VictoryPie` uses the standard `width` prop. [Read about it here](/docs/api/common-props#width)
...
`VictoryPie` uses the standard `x` data accessor prop. [Read about it here](/docs/api/common-props#x)
...
`VictoryPie` uses the standard `y` data accessor prop. [Read about it here](/docs/api/common-props#y)
