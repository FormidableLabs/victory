...
See the [Events Guide](/open-source/victory/docs/guides/events) for more information on defining events.
...
`VictoryArea` uses the standard `labelComponent` prop. [Read about it in detail](/docs/api/victory-labelable-props#datacomponent)
