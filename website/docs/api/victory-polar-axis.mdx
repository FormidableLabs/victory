...
`VictoryPolarAxis` uses the standard `animate` prop. [Read about it here](/docs/api/victory-common-theme-props#animate)
...
`VictoryPolarAxis` uses the standard `containerComponent` prop. [Read about it here](/docs/api/victory-common-theme-props#containercomponent)
...
<div style={{ display: "flex" }}>
  <VictoryPolarAxis dependentAxis theme={VictoryTheme.clean} />
...
`VictoryPolarAxis` uses the standard `domain` prop. [Read about it here](/docs/api/victory-datatable-props#domain)
...
`VictoryPolarAxis` uses the standard `domainPadding` prop. [Read about it here](/docs/api/victory-common-theme-props#domainpadding)
...
`VictoryPolarAxis` uses the standard `externalEventMutations` prop. [Read about it in detail](/docs/api/victory-common-theme-props#externalEventsMutations)
...
`VictoryPolarAxis` uses the standard `groupComponent` prop. [Read about it here](/docs/api/victory-common-theme-props#groupcomponent)
...
`VictoryPolarAxis` uses the standard `height` prop. [Read about it here](/docs/api/victory-common-theme-props#height)
...
`VictoryPolarAxis` uses the standard `maxDomain` prop. [Read about it in detail](/docs/api/victory-common-theme-props#maxDomain)
...
`VictoryPolarAxis` uses the standard `minDomain` prop. [Read about it in detail](/docs/api/victory-common-theme-props#minDomain)
...
`VictoryPolarAxis` uses the standard `name` prop. [Read about it here](/docs/api/common-props#name)
...
`VictoryPolarAxis` uses the standard `padding` prop. [Read about it here](/docs/api/victory-common-theme-props#padding)
...
`VictoryPolarAxis` uses the standard `scale` prop. [Read about it here](/docs/api/victory-common-theme-props#scale)
...
`VictoryPolarAxis` uses the standard `singleQuadrantDomainPadding` prop. [Read about it here](/docs/api/victory-common-theme-props#singlequadrantdomainpadding)
...
`VictoryPolarAxis` uses the standard `standalone` prop. [Read about it here](/docs/api/victory-common-theme-props#standalone)
...
`VictoryPolarAxis` uses the standard `theme` prop. [Read about it here](/docs/api/victory-common-props#theme)
...
:::note
Use the `dependentAxis` and `independentAxis` namespaces to theme axes by type. These namespaces will be merged with any props and styles supplied in the `axis` namespace.
:::
...
`VictoryPolarAxis` uses the standard `width` prop. [Read about it here](/docs/api/victory-common-theme-props#width)
...
[tickformat]: /docs/api/victory-axis#tickformat
...
[arc component]: /docs/api/victory-primitives#arc
