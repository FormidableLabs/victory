...
`VictoryStack` uses the standard `animate` prop. [Read about it here](/docs/api/common-props#animate)
...
`VictoryStack` uses the standard `categories` prop. [Read about it here](/docs/api/common-props#categories)
...
`VictoryStack` uses the standard `containerComponent` prop. [Read about it in detail here](/docs/api/common-props#containercomponent)
...
`VictoryStack` uses the standard `domain` prop. [Read about it in detail here](/docs/api/common-props#domain)
...
`VictoryStack` uses the standard `domainPadding` prop. [Read about it in detail here](/docs/api/common-props#domainpadding)
...
`VictoryStack` uses the standard `eventKey` prop to specify how event targets are addressed. **This prop is not commonly used.** [Read about the `eventKey` prop in more detail here](/docs/api/common-props#eventkey)
...
`VictoryStack` uses the standard `events` prop. [Read about it in more detail here](/docs/api/common-props#events)
...
`VictoryStack` uses the standard `externalEventMutations` prop. [Read about it in detail](/docs/api/common-props#externalEventsMutations)

## groupComponent

`type: element`

`VictoryStack` uses the standard `groupComponent` prop. [Read about it in detail here](/docs/api/common-props#groupcomponent)
...
`VictoryStack` uses the standard `height` prop. [Read about it here](/docs/api/common-props#height)
...
The `horizontal` prop determines whether the children supplied to `VictoryStack` will be laid out vertically or horizontally. The bars will be vertical if this prop is false or unspecified, or horizontal if the prop is set to true. [Read about the horizontal prop in detail](/docs/api/common-props#horizontal)
...
`VictoryStack` uses the standard `maxDomain` prop. [Read about it in detail](/docs/api/common-props#maxDomain)

## minDomain

`type: number || { x: number, y: number }`

`VictoryStack` uses the standard `minDomain` prop. [Read about it in detail](/docs/api/common-props#minDomain)
...
`VictoryStack` uses the standard `padding` prop. [Read about it here](/docs/api/common-props#padding)
...
`VictoryStack` uses the standard `polar` prop. [Read about it here](/docs/api/common-props#polar)
...
`VictoryStack` uses the standard `scale` prop. [Read about it here](/docs/api/common-props#scale)
...
`VictoryStack` uses the standard `singleQuadrantDomainPadding` prop. [Read about it here](/docs/api/common-props#singlequadrantdomainpadding)

## standalone

`type: boolean`

`VictoryStack` uses the standard `standalone` prop. [Read about it here](/docs/api/common-props#standalone)
...
`VictoryStack` uses the standard `style` prop. [Read about it here](/docs/api/common-props#style)
...
`VictoryStack` uses the standard `theme` prop. [Read about it here](/docs/api/common-props#theme)
...
`VictoryStack` uses the standard `width` prop. [Read about it here](/docs/api/common-props#width)
