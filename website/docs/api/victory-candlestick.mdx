...
`VictoryCandlestick` uses the standard `animate` prop. [Read about it here](/docs/api/victory-common-theme-props#animate)
...
`VictoryCandlestick` uses the standard `categories` prop. [Read about it here](/docs/api/victory-datatable-props#categories)
...
`VictoryCandlestick` uses the standard `containerComponent` prop. [Read about it here](/docs/api/victory-common-theme-props#containercomponent)
...
`VictoryCandlestick` uses the standard `dataComponent` prop. [Read about it here](/docs/api/victory-datatable-props#datacomponent)
...
`VictoryCandlestick` uses the standard `domain` prop. [Read about it here](/docs/api/victory-datatable-props#domain)
...
`VictoryCandlestick` uses the standard `domainPadding` prop. [Read about it here](/docs/api/victory-common-theme-props#domainpadding)
...
`VictoryCandlestick` uses the standard `groupComponent` prop. [Read about it here](/docs/api/victory-common-theme-props#groupcomponent)
...
`VictoryCandlestick` uses the standard `height` prop. [Read about it here](/docs/api/victory-common-theme-props#height)
...
`VictoryCandlestick` uses the standard `horizontal` prop. [Read about it in detail](/docs/api/victory-common-theme-props#horizontal)
...
`VictoryCandlestick` uses the standard `labelComponent` prop. [Read about it here](/docs/api/victory-labelable-props#datacomponent)
...
`VictoryCandlestick` uses the standard `labels` prop. [Read about it here](/docs/api/common-props#labels)
...
`VictoryCandlestick` uses the standard `maxDomain` prop. [Read about it in detail](/docs/api/victory-common-theme-props#maxDomain)
...
`VictoryCandlestick` uses the standard `minDomain` prop. [Read about it in detail](/docs/api/victory-common-theme-props#minDomain)
...
`VictoryCandlestick` uses the standard `padding` prop. [Read about it here](/docs/api/victory-common-theme-props#padding)
...
`VictoryCandlestick` uses the standard `polar` prop. [Read about it here](/docs/api/victory-common-theme-props#polar)
...
`VictoryCandlestick` uses the standard `samples` prop. [Read about it here](/docs/api/victory-datatable-props#samples)
...
`VictoryCandlestick` uses the standard `scale` prop. [Read about it here](/docs/api/victory-common-theme-props#scale)
...
`VictoryCandlestick` uses the standard `singleQuadrantDomainPadding` prop. [Read about it here](/docs/api/victory-common-theme-props#singlequadrantdomainpadding)

## sortKey

`type: string || integer || array[string] || function`

`VictoryCandlestick` uses the standard `sortKey` prop. [Read about it here](/docs/api/victory-datatable-props#sortKey)
...
`VictoryCandlestick` uses the standard `standalone` prop. [Read about it here](/docs/api/victory-common-theme-props#standalone)
...
`VictoryCandlestick` uses the standard `theme` prop. [Read about it here](/docs/api/victory-common-props#theme)
...
`VictoryCandlestick` uses the standard `width` prop. [Read about it here](/docs/api/victory-common-theme-props#width)
...
`VictoryCandlestick` uses the standard `x` data accessor prop. [Read about it here](/docs/api/victory-datatable-props#x)
...
[`x`]: /docs/api/victory-candlestick#x
[`open`]: /docs/api/victory-candlestick#open
[`close`]: /docs/api/victory-candlestick#close
[`high`]: /docs/api/victory-candlestick#high
[`low`]: /docs/api/victory-candlestick#low
