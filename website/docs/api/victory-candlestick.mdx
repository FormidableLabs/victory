...
`VictoryCandlestick` uses the standard `animate` prop. [Read about it here](/docs/api/common-props#animate)
...
`VictoryCandlestick` uses the standard `categories` prop. [Read about it here](/docs/api/common-props#categories)
...
`VictoryCandlestick` uses the standard `containerComponent` prop. [Read about it here](/docs/api/common-props#containercomponent)
...
`VictoryCandlestick` uses the standard `dataComponent` prop. [Read about it here](/docs/api/common-props#datacomponent)
...
`VictoryCandlestick` uses the standard `domain` prop. [Read about it here](/docs/api/common-props#domain)
...
`VictoryCandlestick` uses the standard `domainPadding` prop. [Read about it here](/docs/api/common-props#domainpadding)
...
`VictoryCandlestick` uses the standard `eventKey` prop to specify how event targets are addressed. **This prop is not commonly used.** [Read about the `eventKey` prop in more detail here](/docs/api/common-props#eventkey)
...
`VictoryCandlestick` uses the standard `events` prop. [Read about it here](/docs/api/common-props#events)
...
`VictoryCandlestick` uses the standard `groupComponent` prop. [Read about it here](/docs/api/common-props#groupcomponent)
...
`VictoryCandlestick` uses the standard `height` prop. [Read about it here](/docs/api/common-props#height)
...
`VictoryCandlestick` uses the standard `horizontal` prop. [Read about it in detail](/docs/api/common-props#horizontal)
...
`VictoryCandlestick` uses the standard `labelComponent` prop. [Read about it here](/docs/api/common-props#labelcomponent)
...
`VictoryCandlestick` uses the standard `maxDomain` prop. [Read about it in detail](/docs/api/common-props#maxDomain)
...
`VictoryCandlestick` uses the standard `minDomain` prop. [Read about it in detail](/docs/api/common-props#minDomain)
...
`VictoryCandlestick` uses the standard `padding` prop. [Read about it here](/docs/api/common-props#padding)
...
`VictoryCandlestick` uses the standard `polar` prop. [Read about it here](/docs/api/common-props#polar)
...
`VictoryCandlestick` uses the standard `samples` prop. [Read about it here](/docs/api/common-props#samples)
...
`VictoryCandlestick` uses the standard `scale` prop. [Read about it here](/docs/api/common-props#scale)
...
`VictoryCandlestick` uses the standard `singleQuadrantDomainPadding` prop. [Read about it here](/docs/api/common-props#singlequadrantdomainpadding)

## sortKey

`type: string || integer || array[string] || function`

`VictoryCandlestick` uses the standard `sortKey` prop. [Read about it here](/docs/api/common-props#sortkey)
...
`VictoryCandlestick` uses the standard `standalone` prop. [Read about it here](/docs/api/common-props#standalone)
...
`VictoryCandlestick` uses the standard `theme` prop. [Read about it here](/docs/api/common-props#theme)
...
`VictoryCandlestick` uses the standard `width` prop. [Read about it here](/docs/api/common-props#width)
...
`VictoryCandlestick` uses the standard `x` data accessor prop. [Read about it here](/docs/api/common-props#x)
