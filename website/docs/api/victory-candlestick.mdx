...
`VictoryCandlestick` uses the standard `labelComponent` prop. [Read about it here](/docs/api/victory-datatable-props#datacomponent)
...
`VictoryCandlestick` uses the standard `labels` prop. [Read about it here](/docs/api/victory-multi-labelable-props#labels)
