...
auto_generated:
  component: VictoryAccessibleGroup
  props: VictoryAccessibleGroupProps
---
...
```jsx live @example(aria-describedby)
<VictoryChart
  groupComponent={
    <VictoryAccessibleGroup aria-describedby="chart-description" />
  }
>
