...
`VictoryGroup` uses the standard `animate` prop. [Read about it here](/docs/api/victory-common-theme-props#animate)
...
`VictoryGroup` uses the standard `categories` prop. [Read about it here](/docs/api/victory-datatable-props#categories)
...
`VictoryGroup` uses the standard `containerComponent` prop. [Read about it in detail here](/docs/api/victory-common-theme-props#containercomponent)
...
`VictoryGroup` uses the standard `data` prop. [Read about it here](/docs/api/victory-datatable-props#data)
...
`VictoryGroup` uses the standard `domain` prop. [Read about it in detail here](/docs/api/victory-datatable-props#domain)
...
`VictoryGroup` uses the standard `domainPadding` prop. [Read about it in detail here](/docs/api/victory-common-theme-props#domainpadding)
...
`VictoryGroup` uses the standard `externalEventMutations` prop. [Read about it in detail](/docs/api/victory-common-theme-props#externalEventsMutations)
...
`VictoryGroup` uses the standard `groupComponent` prop. [Read about it in detail here](/docs/api/victory-common-theme-props#groupcomponent)
...
`VictoryGroup` uses the standard `height` prop. [Read about it here](/docs/api/victory-common-theme-props#height)
...
The `horizontal` prop determines whether the children supplied to `VictoryGroup` will be laid out vertically or horizontally. [Read about the horizontal prop in detail](/docs/api/victory-common-theme-props#horizontal)
...
`VictoryGroup` uses the standard `maxDomain` prop. [Read about it in detail](/docs/api/victory-common-theme-props#maxDomain)

## minDomain

`type: number || { x: number, y: number }`

`VictoryGroup` uses the standard `minDomain` prop. [Read about it in detail](/docs/api/victory-common-theme-props#minDomain)
...
`VictoryGroup` uses the standard `padding` prop. [Read about it here](/docs/api/victory-common-theme-props#padding)
...
`VictoryGroup` uses the standard `polar` prop. [Read about it here](/docs/api/victory-common-theme-props#polar)
...
`VictoryGroup` uses the standard `samples` prop. [Read about it here](/docs/api/victory-datatable-props#samples)
...
`VictoryGroup` uses the standard `scale` prop. [Read about it here](/docs/api/victory-common-theme-props#scale)
...
`VictoryGroup` uses the standard `singleQuadrantDomainPadding` prop. [Read about it here](/docs/api/victory-common-theme-props#singlequadrantdomainpadding)

## sortKey

`type: string || integer || array[string] || function`

`VictoryGroup` uses the standard `sortKey` prop. [Read about it here](/docs/api/victory-datatable-props#sortKey)
...
`VictoryGroup` uses the standard `standalone` prop. [Read about it here](/docs/api/victory-common-theme-props#standalone)
...
`VictoryGroup` uses the standard `style` prop. [Read about it here](/docs/guides/themes)
...
`VictoryGroup` uses the standard `theme` prop. [Read about it here](/docs/api/victory-common-props#theme)
...
`VictoryGroup` uses the standard `width` prop. [Read about it here](/docs/api/victory-common-theme-props#width)
...
`VictoryGroup` uses the standard `x` data accessor prop. [Read about it here](/docs/api/victory-datatable-props#x)
...
`VictoryGroup` uses the standard `y` data accessor prop. [Read about it here](/docs/api/victory-datatable-props#y)
...
`VictoryGroup` uses the standard `y0` data accessor prop. [Read about it here](/docs/api/victory-datatable-props#y0)
...
[victoryerrorbar]: /docs/api/victory-errorbar
