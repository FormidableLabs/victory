...
`VictoryGroup` uses the standard `animate` prop. [Read about it here](/docs/api/common-props#animate)
...
`VictoryGroup` uses the standard `categories` prop. [Read about it here](/docs/api/common-props#categories)
...
`VictoryGroup` uses the standard `containerComponent` prop. [Read about it in detail here](/docs/api/common-props#containercomponent)
...
`VictoryGroup` uses the standard `data` prop. [Read about it here](/docs/api/common-props#data)
...
`VictoryGroup` uses the standard `domain` prop. [Read about it in detail here](/docs/api/common-props#domain)
...
`VictoryGroup` uses the standard `domainPadding` prop. [Read about it in detail here](/docs/api/common-props#domainpadding)
...
`VictoryGroup` uses the standard `eventKey` prop to specify how event targets are addressed. **This prop is not commonly used.** [Read about the `eventKey` prop in more detail here](/docs/api/common-props#eventkey)
...
`VictoryGroup` uses the standard `events` prop. [Read about it in more detail here](/docs/api/common-props#events)
...
`VictoryGroup` uses the standard `externalEventMutations` prop. [Read about it in detail](/docs/api/common-props#externalEventsMutations)

## groupComponent

`type: element`

`VictoryGroup` uses the standard `groupComponent` prop. [Read about it in detail here](/docs/api/common-props#groupcomponent)
...
`VictoryGroup` uses the standard `height` prop. [Read about it here](/docs/api/common-props#height)
...
The `horizontal` prop determines whether the children supplied to `VictoryGroup` will be laid out vertically or horizontally. [Read about the horizontal prop in detail](/docs/api/common-props#horizontal)
...
`VictoryGroup` uses the standard `maxDomain` prop. [Read about it in detail](/docs/api/common-props#maxDomain)

## minDomain

`type: number || { x: number, y: number }`

`VictoryGroup` uses the standard `minDomain` prop. [Read about it in detail](/docs/api/common-props#minDomain)
...
`VictoryGroup` uses the standard `padding` prop. [Read about it here](/docs/api/common-props#padding)
...
`VictoryGroup` uses the standard `polar` prop. [Read about it here](/docs/api/common-props#polar)
...
`VictoryGroup` uses the standard `samples` prop. [Read about it here](/docs/api/common-props#samples)
...
`VictoryGroup` uses the standard `scale` prop. [Read about it here](/docs/api/common-props#scale)
...
`VictoryGroup` uses the standard `singleQuadrantDomainPadding` prop. [Read about it here](/docs/api/common-props#singlequadrantdomainpadding)

## sortKey

`type: string || integer || array[string] || function`

`VictoryGroup` uses the standard `sortKey` prop. [Read about it here](/docs/api/common-props#sortkey)
...
`VictoryGroup` uses the standard `standalone` prop. [Read about it here](/docs/api/common-props#standalone)
...
`VictoryGroup` uses the standard `style` prop. [Read about it here](/docs/api/common-props#style)
...
`VictoryGroup` uses the standard `theme` prop. [Read about it here](/docs/api/common-props#theme)
...
`VictoryGroup` uses the standard `width` prop. [Read about it here](/docs/api/common-props#width)
...
`VictoryGroup` uses the standard `x` data accessor prop. [Read about it here](/docs/api/common-props#x)
...
`VictoryGroup` uses the standard `y` data accessor prop. [Read about it here](/docs/api/common-props#y)
...
`VictoryGroup` uses the standard `y0` data accessor prop. [Read about it here](/docs/api/common-props#y0)
...
[x]: /docs/api/common-props#x
[y]: /docs/api/common-props#y
