...
`VictoryErrorBar` uses the standard `animate` prop. [Read about it here](/docs/api/common-props#animate)
...
`VictoryErrorBar` uses the standard `categories` prop. [Read about it here](/docs/api/common-props#categories)
...
`VictoryErrorBar` uses the standard `containerComponent` prop. [Read about it here](/docs/api/common-props#containercomponent)
...
`VictoryErrorBar` uses the standard `dataComponent` prop. [Read about it here](/docs/api/common-props#datacomponent)
...
`VictoryErrorBar` uses the standard `domain` prop. [Read about it here](/docs/api/common-props#domain)
...
`VictoryErrorBar` uses the standard `domainPadding` prop. [Read about it here](/docs/api/common-props#domainpadding)
...
`VictoryErrorBar` uses the standard `eventKey` prop to specify how event targets are addressed. **This prop is not commonly used.** [Read about the `eventKey` prop in more detail here](/docs/api/common-props#eventkey)
...
`VictoryErrorBar` uses the standard `events` prop. [Read about it here](/docs/api/common-props#events)
...
`VictoryErrorBar` uses the standard `groupComponent` prop. [Read about it here](/docs/api/common-props#groupcomponent)
...
`VictoryErrorBar` uses the standard `height` prop. [Read about it here](/docs/api/common-props#height)
...
`VictoryErrorBar` uses the standard `horizontal` prop. [Read about it in detail](/docs/api/common-props#horizontal)
...
`VictoryErrorBar` uses the standard `labelComponent` prop. [Read about it here](/docs/api/common-props#labelcomponent)
...
`VictoryErrorBar` uses the standard `labels` prop. [Read about it here](/docs/api/common-props#labels)
...
`VictoryErrorBar` uses the standard `maxDomain` prop. [Read about it in detail](/docs/api/common-props#maxDomain)
...
`VictoryErrorBar` uses the standard `minDomain` prop. [Read about it in detail](/docs/api/common-props#minDomain)
...
`VictoryErrorBar` uses the standard `padding` prop. [Read about it here](/docs/api/common-props#padding)
...
`VictoryErrorBar` uses the standard `polar` prop. [Read about it here](/docs/api/common-props#polar)
...
`VictoryErrorBar` uses the standard `samples` prop. [Read about it here](/docs/api/common-props#samples)
...
`VictoryErrorBar` uses the standard `scale` prop. [Read about it here](/docs/api/common-props#scale)
...
`VictoryErrorBar` uses the standard `singleQuadrantDomainPadding` prop. [Read about it here](/docs/api/common-props#singlequadrantdomainpadding)

## sortKey

`type: string || integer || array[string] || function`

`VictoryErrorBar` uses the standard `sortKey` prop. [Read about it here](/docs/api/common-props#sortkey)
...
`VictoryErrorBar` uses the standard `standalone` prop. [Read about it here](/docs/api/common-props#standalone)
...
`VictoryErrorBar` uses the standard `style` prop. [Read about it here](/docs/api/common-props#style)
...
`VictoryErrorBar` uses the standard `theme` prop. [Read about it here](/docs/api/common-props#theme)
...
`VictoryErrorBar` uses the standard `width` prop. [Read about it here](/docs/api/common-props#width)
...
`VictoryErrorBar` uses the standard `x` data accessor prop. [Read about it here](/docs/api/common-props#x)
...
`VictoryErrorBar` uses the standard `y` data accessor prop. [Read about it here](/docs/api/common-props#y)
