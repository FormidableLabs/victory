...
`VictoryLegend` uses the standard `containerComponent` prop. [Read about it here](/docs/api/common-props#containercomponent)
...
`VictoryLegend` uses the standard `dataComponent` prop. [Read about it here](/docs/api/common-props#datacomponent)
...
`VictoryLegend` uses the standard `eventKey` prop to specify how event targets are addressed. **This prop is not commonly used.** [Read about the `eventKey` prop in more detail here](/docs/api/common-props#eventkey)
...
`VictoryLegend` uses the standard `events` prop. [Read about it here](/docs/api/common-props#events)
...
`VictoryLegend` uses the standard `externalEventMutations` prop. [Read about it in detail](/docs/api/common-props#externalEventsMutations)

## groupComponent

`type: element`

`VictoryLegend` uses the standard `groupComponent` prop. [Read about it here](/docs/api/common-props#groupcomponent)
...
`VictoryLegend` uses the standard `height` prop. [Read about it here](/docs/api/common-props#height)
...
`VictoryLegend` uses the standard `labelComponent` prop. [Read about it here](/docs/api/common-props#labelcomponent)
...
`VictoryLegend` uses the standard `padding` prop. [Read about it here](/docs/api/common-props#padding)
...
`VictoryLegend` uses the standard `width` prop. [Read about it here](/docs/api/common-props#width)
