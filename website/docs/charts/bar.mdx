...
Bar charts support zoom and pan behavior by using the `VictoryZoomContainer` component. See the [Brush & Zoom](/docs/guides/brush-and-zoom) guide for more information.
