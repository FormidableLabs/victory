      ...
      describe(`symmetric error, rendering data ${testLabel}`, () => {
        ...
        it("sorts data by sortKey prop", () => {
          ...
          const xValues = wrapper
            .find(ErrorBar)
            .map((errorBar) => errorBar.prop("datum")._x);
        ...
        it("should check right border of error bars positions", () => {
          ...
          Data.forEach((node, i) => {
            ...
            expect(rightBorder.props().y1).to.equal(
              yScale(data[i].y) - borderWidth
            );
            expect(rightBorder.props().y2).to.equal(
              yScale(data[i].y) + borderWidth
            );
          });
        });
        ...
        it("should check left border of error bars positions", () => {
          ...
          Data.forEach((node, i) => {
            ...
            expect(leftBorder.props().y1).to.equal(
              yScale(data[i].y) - borderWidth
            );
            expect(leftBorder.props().y2).to.equal(
              yScale(data[i].y) + borderWidth
            );
          });
        });
        ...
        it("should check bottom border of error bars positions", () => {
          ...
          Data.forEach((node, i) => {
            ...
            expect(bottomBorder.props().x1).to.equal(
              xScale(data[i].x) - borderWidth
            );
            expect(bottomBorder.props().x2).to.equal(
              xScale(data[i].x) + borderWidth
            );
        ...
        it("should check top border of error bars positions", () => {
          ...
          Data.forEach((node, i) => {
            ...
            expect(topBorder.props().x1).to.equal(
              xScale(data[i].x) - borderWidth
            );
            expect(topBorder.props().x2).to.equal(
              xScale(data[i].x) + borderWidth
            );
        ...
        it("should check top cross line of error bars positions", () => {
          ...
          const wrapper = mount(
            <VictoryErrorBar data={createData(data)} {...svgDimensions} />
          );
    ...
    describe("accessibility", () => {
      it("adds an aria label-label and tabIndex to Error Bar primitive", () => {
        ...
        wrapper
          ...
          .slice(1)
          .forEach((g, i) => {
            expect(g.prop("aria-label")).to.equal(
