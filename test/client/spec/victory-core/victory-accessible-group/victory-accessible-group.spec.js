...
import VictoryAccessibleGroup from "packages/victory-core/src/victory-accessible-group/victory-accessibility-group";
import { wrap } from "lodash";

describe("components/victory-accessible-group", () => {
  it("renders an g with an aria-label", () => {
    const wrapper = mount(<VictoryAccessibleGroup aria-label="test-aria-label" />);
  ...
  it("renders an g with a tabIndex and className", () => {
    const wrapper = mount(<VictoryAccessibleGroup tabIndex={5} className="accessibility" />);
