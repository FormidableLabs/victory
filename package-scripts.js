...
module.exports = {
  scripts: {
    ...
    watch: {
      es: 'lerna exec --parallel --ignore victory-native --ignore victory-vendor -- cross-env BABEL_ENV=es babel src --out-dir es --config-file ../../.babelrc.js --ignore "**/*.test.js" --copy-files --no-copy-ignored --extensions .tsx,.ts,.jsx,.js --watch',
      lib: 'lerna exec --parallel --ignore victory-native --ignore victory-vendor -- cross-env BABEL_ENV=commonjs babel src --out-dir lib --config-file ../../.babelrc.js --ignore "**/*.test.js" --copy-files --no-copy-ignored --extensions .tsx,.ts,.jsx,.js --watch',
    ...
    "babel-es":
      'cross-env BABEL_ENV=es babel src --out-dir es --config-file ../../.babelrc.js --ignore "**/*.test.js" --copy-files --no-copy-ignored --extensions .tsx,.ts,.jsx,.js',
    "babel-lib":
      'cross-env BABEL_ENV=commonjs babel src --out-dir lib --config-file ../../.babelrc.js --ignore "**/*.test.js" --copy-files --no-copy-ignored --extensions .tsx,.ts,.jsx,.js',
