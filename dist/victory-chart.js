...
/***/ function(module, exports, __webpack_require__) {
	...
	var _victoryLine = __webpack_require__(20);
	
	var _victoryAxis = __webpack_require__(22);
	...
	var VictoryChart = (function (_React$Component) {
	  ...
	  function VictoryChart(props) {
	    ...
	    if (this.props.data) {
	      this.state = {
	        ...
	        x: this.props.data.map(function (row) {
	          return row.x;
	        }),
	        y: this.props.data.map(function (row) {
	          return row.y;
	        })
	      };
	    } else {
	  ...
	  _createClass(VictoryChart, [{
	    ...
	    value: function returnOrGenerateX() {
	      var step = Math.round(this.props.xMax / this.props.sample, 4);
	      return this.props.x ? this.props.x : _lodash2["default"].range(this.props.xMin, this.props.xMax, step);
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      return _react2["default"].createElement(
	        "svg",
	        { style: styles.svg },
	        _react2["default"].createElement(_victoryLine.VictoryLine, { data: this.state.data,
	          style: styles.svg
	        }),
	        _react2["default"].createElement(_victoryAxis.VictoryAxis, { data: this.state.data,
	          style: styles.svg
	        })
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var resolveStyles = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MouseUpListener = __webpack_require__(9);
	var getState = __webpack_require__(10);
	var getStateKey = __webpack_require__(11);
	var Prefixer = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createMarkupForStyles = __webpack_require__(17);
	var Prefixer = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  VictoryLine: __webpack_require__(21)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  VictoryAxis: __webpack_require__(23)
	};
	    ...
	    value: function render() {
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          "g",
	          { ref: "xAxis", style: styles.xAxis, transform: this.getXTransform() },
	          this.state.xAxis
	        ),
	        _react2["default"].createElement(
	          "g",
	          { ref: "yAxis", style: styles.yAxis, transform: this.getYTransform() },
	          this.state.yAxis
	        )
	      );
	    }
