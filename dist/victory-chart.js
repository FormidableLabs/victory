...
/***/ function(module, exports, __webpack_require__) {
	...
	var _d3 = __webpack_require__(19);
	...
	var _victoryLine = __webpack_require__(23);
	
	var _victoryAxis = __webpack_require__(25);
	
	var _victoryScatter = __webpack_require__(30);
	...
	var VictoryChart = (function (_React$Component) {
	  ...
	  _createClass(VictoryChart, [{
	    ...
	    key: "inCaseOfYData",
	    value: function inCaseOfYData(datasets) {
	      var _this = this;
	
	      var xArrays = this.returnOrGenerateX(); // returns an array of arrays
	      var yArrays = this.returnOrGenerateY(); // returns an array of arrays
	      var n = undefined;
	      var xArray = undefined;
	      // create dataArrays of n points from each x array and each y array
	      var dataArrays = _lodash2["default"].map(yArrays, function (y, index) {
	        xArray = xArrays[index] || xArrays[0];
	        n = _lodash2["default"].min([xArray.length, y.length]);
	        return _lodash2["default"].zip(_lodash2["default"].take(xArray, n), _lodash2["default"].take(y, n));
	      });
	      ...
	      _lodash2["default"].each(dataArrays, function (dataArray, index) {
	        datasets.push({
	          attrs: _this._getAttributes("y", index),
	          data: _lodash2["default"].map(dataArray, function (datum) {
	            return {
	              x: datum[0],
	              y: datum[1]
	            };
	    ...
	    key: "consolidateData",
	    value: function consolidateData() {
	      var _this2 = this;
	      ...
	      var defaultData = function defaultData(x) {
	        return x;
	      };
	      var yData = !this.props.data && !this.props.y ? defaultData : this.props.y;
	      ...
	      if (this.props.data) {
	        if (_lodash2["default"].isArray(this.props.data[0])) {
	          _lodash2["default"].each(this.props.data, function (dataset, index) {
	            datasets.push({
	              attrs: _this2._getAttributes("data", index),
	              data: dataset
	            });
	          });
	        } else {
	    ...
	    key: "_getAttributes",
	    value: function _getAttributes(type, index) {
	      // type is y or data
	      var source = type + "Attributes";
	      var attributes = this.props[source] && this.props[source][index] ? this.props[source][index] : this.props[source];
	    ...
	    value: function returnOrGenerateX() {
	      if (this.props.x) {
	        return _lodash2["default"].isArray(this.props.x[0]) ? this.props.x : [this.props.x];
	      }
	      ...
	      var domainFromProps = this.props.domain && this.props.domain.x ? this.props.domain.x : this.props.domain;
	
	      // domain based on tickValues if they are given
	      var domainFromTicks = this.props.tickValues ? [_lodash2["default"].min(this.props.tickValues.x), _lodash2["default"].max(this.props.tickValues.x)] : undefined;
	
	      // domain based on this.props.data if it is given
	      var domainFromData = this.props.data ? this._getDomainFromDataProps("x") : undefined;
	
	      // domain based on this.props.scale
	      // note: this.props.scale  will never be undefined thanks to default props
	      var domainFromScale = this.props.scale.x ? this.props.scale.x().domain() : this.props.scale().domain();
	      ...
	      var samples = this._getNumSamples();
	      var step = (_lodash2["default"].max(domain) - _lodash2["default"].min(domain)) / samples;
	    ...
	    value: function _getDomainFromDataProps(type) {
	      var data = _lodash2["default"].flatten(this.props.data);
	      return [_lodash2["default"].min(_lodash2["default"].pluck(data, type)), _lodash2["default"].max(_lodash2["default"].pluck(data, type))];
	    }
	
	    // helper for returnOrGenerateX
	  }, {
	    key: "_getNumSamples",
	    value: function _getNumSamples() {
	      // if y props exist and have some sensible length, return that length
	      var yArray = _lodash2["default"].isArray(this.props.y) ? this.props.y : undefined;
	    ...
	    value: function returnOrGenerateY() {
	      ...
	      var y = !this.props.data && !this.props.y ? this.defaultData : this.props.y;
	      var xArray = this.returnOrGenerateX();
	      if (_lodash2["default"].isFunction(y)) {
	        // if y is a function, apply it to each element in each x array
	        return _lodash2["default"].map(xArray, function (xSegment) {
	          return _lodash2["default"].map(xSegment, function (datum) {
	            return y(datum);
	          });
	        });
	        ...
	        var _ret = (function () {
	          ...
	          var x = undefined;
	          return {
	            v: _lodash2["default"].map(y, function (yElement, index) {
	              x = xArray[index] || xArray[0];
	              return _lodash2["default"].isFunction(yElement) ? _lodash2["default"].map(x, function (datum) {
	                return yElement(datum);
	              }) : yElement;
	            })
	          };
	        })();
	    ...
	    value: function getDomain(type) {
	      ...
	      if (this.props.domain) {
	        ...
	        domain = [_lodash2["default"].min(this.props.tickValues[type]), _lodash2["default"].max(this.props.tickValues[type])];
	      } else {
	      ...
	      var otherAxis = type === "x" ? "y" : "x";
	      var orientation = this.props.axisOrientation[otherAxis];
	    ...
	    value: function _getDomainFromData(type) {
	      var data = _lodash2["default"].map(this.consolidateData(), function (dataset) {
	        return dataset.data;
	      });
	      var min = [];
	      var max = [];
	      _lodash2["default"].each(data, function (datum) {
	        min.push(_lodash2["default"].min(_lodash2["default"].pluck(datum, type)));
	        max.push(_lodash2["default"].max(_lodash2["default"].pluck(datum, type)));
	      });
	      return [_lodash2["default"].min(min), _lodash2["default"].max(max)];
	    }
	  }, {
	    key: "getRange",
	    ...
	    value: function getAxisOffset() {
	      ...
	      var origin = {
	        x: _lodash2["default"].max([_lodash2["default"].min(this.getDomain("x")), 0]),
	        y: _lodash2["default"].max([_lodash2["default"].min(this.getDomain("y")), 0])
	      };
	    ...
	    value: function getTickValues(type) {
	      var scale = this.getScale(type);
	      if (this.props.tickValues) {
	        return this.props.tickValues[type];
	      } else if (_lodash2["default"].isFunction(scale.ticks)) {
	        var ticks = scale.ticks(this.props.tickCount[type]);
	        return _lodash2["default"].without(ticks, 0);
	      } else {
	        return scale.domain();
	      }
	    }
	    ...
	    key: "drawLine",
	    value: function drawLine(dataset, index) {
	      var style = this.getStyles();
	      ...
	      var animate = this.props.animate.line !== undefined ? this.props.animate.line : this.props.animate;
	      return _react2["default"].createElement(_victoryLine.VictoryLine, _extends({}, this.props, {
	        animate: animate,
	        containerElement: "g",
	        data: dataset.data,
	        style: _lodash2["default"].merge(style, attrs),
	    ...
	    key: "drawScatter",
	    value: function drawScatter(dataset, index) {
	      var style = this.getStyles();
	      ...
	      var animate = this.props.animate.scatter !== undefined ? this.props.animate.scatter : this.props.animate;
	      return _react2["default"].createElement(_victoryScatter.VictoryScatter, _extends({}, this.props, {
	        animate: animate,
	        containerElement: "g",
	        data: dataset.data,
	        size: size || 3,
	    ...
	    key: "drawBar",
	    value: function drawBar(dataset, index) {
	      var style = this.getStyles();
	      var axisWidth = 1; // placeholder, connect to variable above later
	      return _react2["default"].createElement(_victoryBar.VictoryBar, {
	        svg: false,
	    ...
	    value: function drawData() {
	      ...
	      var type = undefined;
	      return _lodash2["default"].map(this.consolidateData(), function (dataset, index) {
	        type = dataset.attrs.type;
	        if (type === "line") {
	          return _this3.drawLine(dataset, index);
	        } else if (type === "scatter") {
	          return _this3.drawScatter(dataset, index);
	        } else if (type === "bar") {
	          return _this3.drawBar(dataset, index);
	        }
	      });
	    }
	  }, {
	    ...
	    value: function drawAxis(axis) {
	      var style = this.getStyles();
	      var offsetY = axis === "y" ? undefined : this.getAxisOffset().y;
	      var offsetX = axis === "x" ? undefined : this.getAxisOffset().x;
	      var axisStyle = this.props.axisStyle ? this.props.axisStyle : undefined;
	      var tickStyle = this.props.tickStyle ? this.props.tickStyle : undefined;
	      var gridStyle = this.props.gridStyle ? this.props.gridStyle : undefined;
	      var animate = this.props.animate.axis !== undefined ? this.props.animate.axis : this.props.animate;
	...
	VictoryChart.propTypes = {
	  ...
	  barColors: _react2["default"].PropTypes.array,
	  barData: _react2["default"].PropTypes.array,
	  data: _react2["default"].PropTypes.oneOfType([// maybe this should just be "node"
	  ...
	  animate: _react2["default"].PropTypes.oneOfType([_react2["default"].PropTypes.bool, _react2["default"].PropTypes.shape({
	    line: _react2["default"].PropTypes.bool,
	    scatter: _react2["default"].PropTypes.bool,
	    axis: _react2["default"].PropTypes.bool
	  })]),
	...
	VictoryChart.defaultProps = {
	  ...
	  tickFormat: {
	    x: function x() {
	      return _d32["default"].scale.linear().tickFormat();
	    },
	    y: function y() {
	      return _d32["default"].scale.linear().tickFormat();
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  VictoryLine: __webpack_require__(24)
	};
	...
	var VictoryLine = (function (_React$Component) {
	  ...
	  function VictoryLine(props) {
	    ...
	    if (this.props.data) {
	      ...
	      this.state.x = this.props.data.map(function (row) {
	        return row.x;
	      });
	      this.state.y = this.props.data.map(function (row) {
	        return row.y;
	      });
	    } else {
	      ...
	      var inter = _lodash2["default"].zip(this.state.x, this.state.y);
	      var objs = _lodash2["default"].map(inter, function (obj) {
	  ...
	  _createClass(VictoryLine, [{
	    key: "returnOrGenerateX",
	    value: function returnOrGenerateX() {
	      var step = Math.round(this.state.xRange.max / this.props.sample, 4);
	      return this.props.x ? this.props.x : _lodash2["default"].range(this.state.xRange.min, this.state.xRange.max, step);
	    }
	  }, {
	    key: "returnOrGenerateY",
	    value: function returnOrGenerateY() {
	      ...
	      if (typeof y === "object" && y.isArray()) {
	        ...
	        return _lodash2["default"].map(this.state.x, function (x) {
	          return y(x);
	        });
	      } else {
	        // asplode
	    ...
	    value: function render() {
	      ...
	      var xScale = this.props.scale(this.state.xRange.min, this.state.xRange.max);
	      var yScale = this.props.scale(this.state.yRange.max, this.state.yRange.min);
	
	      xScale.domain(_d32["default"].extent(this.state.data, function (obj) {
	        return obj.x;
	      }));
	      yScale.domain(_d32["default"].extent(this.state.data, function (obj) {
	        return obj.y;
	      }));
	
	      var d3Line = _d32["default"].svg.line().interpolate(this.props.interpolation).x(function (obj) {
	        return xScale(obj.x);
	      }).y(function (obj) {
	        return yScale(obj.y);
	      });
	
	      var path = d3Line(this.state.data);
	
	      return _react2["default"].createElement(
	        "svg",
	        { style: [styles.svg, this.props.style] },
	        _react2["default"].createElement("path", { style: [styles.path, this.props.style],
	          d: path })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  VictoryAxis: __webpack_require__(26)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _victoryAnimation = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  VictoryAnimation: __webpack_require__(29)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  VictoryScatter: __webpack_require__(31)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VictoryBar = (function (_React$Component) {
	  ...
	  _createClass(VictoryBar, [{
	    ...
	    value: function drawStackedBars() {
	      ...
	      var x = _d32["default"].scale.ordinal().rangeRoundBands([0, this.props.width - this.props.totalReductionInX], .1).domain(localCopyOfData.map(function (bar) {
	        return bar.label;
	      }));
	
	      var y = _d32["default"].scale.linear().rangeRound([this.props.height - this.props.totalReductionInY, 0]).domain([0, _d32["default"].max(localCopyOfData, function (bar) {
	        return bar.total;
	      })]);
	...
	VictoryBar.propTypes = {
	  ...
	  totalReductionInY: _react2["default"].PropTypes.number,
	  totalReductionInX: _react2["default"].PropTypes.number
	};
