...
function getChildClipPathToExit(animate, child, data, exitingNodes, cb) {
  let clipWidth;
...
function getChildPropsOnExit(animate, child, data, exitingNodes, cb) { // eslint-disable-line max-params
