...
import BrushArea from "./brush-area";
...
const options = {
  components: [
    ...
    { name: "brushArea", index: 0 },
    { name: "brush", index: 0 },
    { name: "brushHandle", index: 0 },
    { name: "grid" },
...
class VictoryBrushAxis extends React.Component {
  static displayName = "VictoryBrushAxis";
  ...
  static propTypes = {
    ...
    brushHandleComponent: PropTypes.element,
    ...
    events: PropTypes.arrayOf(PropTypes.shape({
      target: PropTypes.oneOf([
        "axis", "axisLabel", "grid", "ticks", "tickLabels", "brushArea", "brush", "brushHandles"
      ]),
    ...
    style: PropTypes.shape({
      ...
      brush: PropTypes.object, brushArea: PropTypes.object, brushHandles: PropTypes.object,
  ...
  static expectedComponents = [
    "axisComponent", "axisLabelComponent", "containerComponent",
    "brushAreaComponent", "brushComponent", "brushHandleComponent",
    "groupComponent", "tickComponent", "tickLabelComponent", "gridComponent"
  ];
  ...
  renderBrushArea(props) {
    const { brushAreaComponent } = props;
    const brushAreaProps = this.getComponentProps(brushAreaComponent, "brushArea", 0);
...
export default addEvents(VictoryBrushAxis, options);
