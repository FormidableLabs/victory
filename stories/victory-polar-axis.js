...
storiesOf("VictoryPolarAxis", module).add("default rendering", () => <VictoryPolarAxis />);
...
storiesOf("VictoryPolarAxis.axisValue", module).add("axisValue when used with chart", () => (
...
storiesOf("VictoryPolarAxis.startAngle and endAngle", module)
  .add("startAngle = 45", () => <VictoryPolarAxis theme={VictoryTheme.material} startAngle={45} />)
  .add("endAngle = 90", () => <VictoryPolarAxis theme={VictoryTheme.material} endAngle={90} />)
...
storiesOf("VictoryPolarAxis.innerRadius", module).add("innerRadius = 50", () => (
