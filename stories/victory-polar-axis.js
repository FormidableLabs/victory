...
import { VictoryPolarAxis, VictoryChart } from "../src/index";
...
storiesOf("VictoryPolarAxis/default", module)
  .add("VictoryPolarAxis", () => <VictoryPolarAxis/>);
...
storiesOf("VictoryPolarAxis/issues", module)
  .addDecorator(ignoredDecorator)
  .add("placeholder", () => <VictoryPolarAxis/>);
storiesOf("VictoryPolarAxis/fixed", module)
  .add("placeholder", () => <VictoryPolarAxis/>);
