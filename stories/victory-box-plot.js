...
storiesOf("VictoryBoxPlot", module).add("default rendering", () => <VictoryBoxPlot />);
...
storiesOf("VictoryBoxPlot.tooltips", module)
  ...
  .add("q1Labels tooltips", () => (
    <VictoryBoxPlot
      ...
      data={getData(5)}
      q1Labels
      q1LabelComponent={<VictoryTooltip active />}
    />
  ))
  .add("medianLabels tooltips", () => (
    <VictoryBoxPlot
      ...
      data={getData(5)}
      medianLabels
      medianLabelComponent={<VictoryTooltip active />}
    />
  ))
  ...
  .add("maxLabels tooltips", () => (
    <VictoryBoxPlot
      ...
      data={getData(5)}
      maxLabels
      maxLabelComponent={<VictoryTooltip active />}
    />
  ));
